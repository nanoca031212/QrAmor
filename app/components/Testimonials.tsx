...
const reviews = [
  {
    name: "Bru & Manu",
    content:
      "Achei q ia ser difícil de fazer mas é mó de boa. A música de fundo deu mó clima 😍",
  },
  {
    name: "Fe & Gi",
    content:
      "O QR Code funcionou direitinho no jantar. Foi o ponto alto da noite, vlw msm!",
  },
  {
    name: "Dani & Lice",
    content:
      "Cara, mt foda. É uma parada q fica pra sempre, tlgd? Não é que nem presente q acaba ou quebra.",
  },
  {
    name: "Dedé & Lena",
    content:
      "Sem palavras... ficou mto profissa! Parece q paguei uma fortuna pra um designer fazer.",
  },
  {
    name: "Nick",
  ...
  },
  {
    name: "Fer & Sah",
    content:
      "Eu tava sem ideia do q dar e isso salvou meu namoro kkkk brincadeira, mas ajudou mto!",
  },
  {
    name: "Will & Carol",
    content:
      "Aquele contador de tempo é hipnotizante. A gnt fica olhando os segundos passarem juntinhos.",
  },
  {
    name: "Leo & Bia",
    content:
      "Nossa primeira viagem registrada para sempre juntas. Amei cada detalhe!",
  },
];
    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          ...
          >
            Histórias reais.{" "}
            <span className="text-brand-purple">Emoções de verdade.</span>
          </motion.h2>

          <p className="text-white/50 text-sm md:text-base max-w-2xl mb-12">
            Mais de 10.000 casais já eternizaram suas histórias. Veja o que eles
            estão dizendo.
          </p>
          ...
          <div className="w-full max-w-2xl grid grid-cols-1 md:grid-cols-3 gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                <span className="text-[10px] uppercase font-bold text-white/40 whitespace-nowrap">
                  {bar.label}
                </span>
