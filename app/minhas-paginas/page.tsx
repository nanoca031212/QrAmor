...
import { Heart, PlusCircle, Settings, LogOut } from "lucide-react";
            ...
            {pages.map((page) => (
              ...
              >
                ...
                <Link
                  ...
                  className="mt-auto inline-flex items-center gap-1 text-xs font-semibold text-fuchsia-400 hover:text-fuchsia-300 transition-colors"
                >
                  Editar página →
                </Link>
              </div>
